...
# def decode_ngram(orig_tokens, word2block, token_logits, n, pooling=None, sum_tf=False):
#     '''
#     Combine n-gram score and sorted 
#     Inputs :
#         n : n_gram
...
# #         if word2block[i] != 0 and (word2block[i] != word2block[i+n-1]):
# #             continue
