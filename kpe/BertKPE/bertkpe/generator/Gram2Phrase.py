...
def gram2phrase(examples, logit_lists, indices, max_phrase_words, return_num, stem_flag=False):
    batch_predictions = []
...
#         n_best_phrases, n_best_scores = decode_n_best_candidates(**params)
#         candidate_KP = remove_empty(n_best_phrases)
#         candidate_KP = remove_empty(n_best_phrases)[:return_num]
#         assert len(candidate_KP) == return_num
#         batch_predictions.append((example['url'], candidate_KP))
